...
-- Retorna todos os registros da tabela a esquerda, mesmo que NÃO tenham correspondência na tabela à direita.
SELECT *
FROM Clientes cli
LEFT JOIN Pedidos ped ON cli.IdCliente = ped.IdCliente

-- Retorna todos os registros da tabela a direita, mesmo que NÃO tenham correspondência na tabela à esquerda.
SELECT *
FROM Clientes cli
